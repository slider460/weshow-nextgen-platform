  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-600/10"></div>
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-purple-500 to-blue-600 rounded-3xl mb-6">
                <Projector className="h-10 w-10 text-white" />
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-900 mb-6">
                Проекторы (от 10000 люмен)
              </h1>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Высокояркостная проекция для любых условий освещения
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое высокояркостные проекторы?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Проекторы от 10000 люмен — это профессиональное оборудование, 
                  способное создавать яркие и четкие изображения даже при ярком освещении.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши проекторы идеально подходят для больших помещений, 
                  уличных мероприятий и профессиональных презентаций.
                </p>
              </div>
              <div className="bg-gradient-to-br from-purple-500 to-blue-600 rounded-3xl p-8 text-white">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    ...
                    Высокая яркость от 10000 люмен
                  </li>
                  <li className="flex items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Применение высокояркостных проекторов
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Уличные мероприятия</h3>
                <p className="text-slate-600">Проекции на здания и сооружения</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Большие залы</h3>
                <p className="text-slate-600">Конференции и презентации</p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для проекторов
            </p>
