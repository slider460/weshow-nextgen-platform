      ...
      <div className="relative pt-20 pb-12 lg:pt-24 lg:pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[calc(100vh-120px)] lg:min-h-[calc(100vh-160px)]">
            ...
            <div className="lg:col-span-5 lg:pr-4 relative z-20 overflow-visible min-h-[400px] lg:min-h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 flex flex-col sm:flex-row gap-4 lg:gap-6 pt-4 lg:pt-6 z-50 pointer-events-auto">
                  <Button 
                    size="lg" 
                    className="px-8 lg:px-10 py-4 lg:py-5 text-base lg:text-lg font-semibold bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-400 hover:to-purple-400 text-white border-0 shadow-2xl hover:shadow-blue-500/25 hover:scale-105 transition-all duration-300 rounded-full group relative overflow-hidden pointer-events-auto z-50"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                  </Button>
                  
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="px-8 lg:px-10 py-4 lg:py-5 text-base lg:text-lg font-semibold bg-white/10 backdrop-blur-md border-white/30 text-white hover:bg-white/20 hover:border-white/50 transition-all duration-300 rounded-full group relative z-50 cursor-pointer pointer-events-auto"
                    onClick={() => navigate('/portfolio')}
                  >
                    <span className="group-hover:animate-pulse pointer-events-none">Наши проекты</span>
                  </Button>
              </div>
            </div>
