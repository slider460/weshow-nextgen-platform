  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-primary-light text-primary-foreground hover:from-primary-light hover:to-primary-glow shadow-lg hover:shadow-xl transform hover:scale-105",
        ...
        premium: "bg-gradient-to-r from-accent to-accent-light text-accent-foreground border border-accent/20 hover:border-accent shadow-lg hover:shadow-xl transform hover:scale-105",
      },
      size: {
