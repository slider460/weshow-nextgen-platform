...
const translations = {
  ru: {
    ...
    'subscription.success': 'Спасибо за подписку! Теперь вы будете получать информацию о новостях, последних технологиях и специальных предложениях.',
  ...
  en: {
    ...
    'subscription.success': "Thanks for subscribing! You will now receive news, latest tech updates and special offers.",
