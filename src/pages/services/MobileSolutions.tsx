...
import { ArrowLeft, Smartphone, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                iOS и Android разработка для создания инновационных мобильных приложений
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое мобильные решения?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Мобильные решения — это специализированные приложения для iOS и Android, 
                  разработанные с учетом особенностей мобильных устройств и пользовательского опыта.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения обеспечивают высокую производительность, 
                  удобство использования и современный дизайн.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Бизнес-приложения</h3>
                <p className="text-slate-600">Корпоративные решения для бизнеса</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Мобильные магазины и приложения</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Игры и развлекательные приложения</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для мобильных приложений
            </p>
