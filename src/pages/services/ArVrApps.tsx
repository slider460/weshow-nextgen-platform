...
import { ArrowLeft, Layers, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Дополненная и виртуальная реальность для создания инновационных решений
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое AR/VR приложения?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  AR/VR приложения — это инновационные технологии, которые создают 
                  иммерсивные и интерактивные пользовательские опыты.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения объединяют реальный и виртуальный миры, 
                  открывая новые возможности для бизнеса и развлечений.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Маркетинг и реклама</h3>
                <p className="text-slate-600">Интерактивные презентации продуктов</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Развлечения и игры</h3>
                <p className="text-slate-600">Иммерсивные игровые опыты</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для AR/VR приложений
            </p>
