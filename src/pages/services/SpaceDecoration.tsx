          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Создание уникальной атмосферы для мероприятий и пространств
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое декорирование пространства?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Декорирование пространства — это искусство создания уникальной атмосферы 
                  для мероприятий, выставок и коммерческих пространств.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения помогают преобразить любое помещение, 
                  создавая запоминающиеся впечатления для посетителей.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Применение декорирования пространства
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Свадьбы, корпоративы, выставки</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Коммерческие пространства</h3>
                <p className="text-slate-600">Магазины, рестораны, офисы</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Стенды и экспозиции</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для декорирования пространства
            </p>
