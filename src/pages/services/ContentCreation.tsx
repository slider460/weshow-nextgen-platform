          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Анимация и видеоконтент для создания захватывающих визуальных впечатлений
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Создание контента — это процесс разработки уникального визуального материала, 
                  включающего анимацию, видео и интерактивные элементы.
                </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Реклама и маркетинг</h3>
                <p className="text-slate-600">Видеоролики и анимация для продвижения</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Обучающие видео и анимация</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Игровые трейлеры и промо-материалы</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для создания контента
            </p>
