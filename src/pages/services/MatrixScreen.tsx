          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Многосегментные LED дисплеи для создания масштабных визуальных инсталляций
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое матричный экран?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Матричный экран — это модульная система LED дисплеев, которая позволяет создавать 
                  экраны любого размера и формы, адаптируясь под ваши потребности.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Каждый модуль может работать независимо или в составе единой системы, 
                  обеспечивая гибкость и масштабируемость решения.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Спортивные арены</h3>
                <p className="text-slate-600">Большие экраны для трансляции матчей</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Концертные залы</h3>
                <p className="text-slate-600">Фон для выступлений и шоу</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Рекламные и информационные экраны</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для матричного экрана
            </p>
