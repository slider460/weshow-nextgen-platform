...
import { ArrowLeft, Gamepad2, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Жестовое управление и распознавание движений для создания захватывающих игровых опытов
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое интерактивные игры?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Интерактивные игры — это современные игровые решения, которые используют 
                  жестовое управление и распознавание движений для создания иммерсивного опыта.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши игры позволяют игрокам взаимодействовать с виртуальным миром 
                  через естественные движения тела и жесты.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Обучение</h3>
                <p className="text-slate-600">Интерактивные образовательные программы</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Фитнес</h3>
                <p className="text-slate-600">Игровые тренировки и упражнения</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для интерактивных игр
            </p>
