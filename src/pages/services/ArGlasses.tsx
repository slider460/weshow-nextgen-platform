...
import { ArrowLeft, Eye, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                AR технологии для создания инновационных пользовательских опытов
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Очки дополненной реальности — это носимые устройства, которые накладывают 
                  цифровую информацию на реальный мир, создавая смешанную реальность.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения позволяют пользователям взаимодействовать с цифровым контентом, 
                  оставаясь в контексте реального мира.
                </p>
              </div>
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-8 text-white">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    ...
                    Накладывание цифровой информации
                  </li>
                  <li className="flex items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Применение очков дополненной реальности
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Обучение и тренажеры</h3>
                <p className="text-slate-600">Интерактивные обучающие программы</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Промышленность</h3>
                <p className="text-slate-600">Техническое обслуживание и ремонт</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Медицина</h3>
                <p className="text-slate-600">Хирургические процедуры и диагностика</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для очков дополненной реальности
            </p>
