          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Профессиональная установка и настройка мультимедийного оборудования
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое установка оборудования?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Установка оборудования — это комплекс услуг по монтажу, 
                  настройке и запуску мультимедийных систем.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши специалисты обеспечивают правильную установку, 
                  оптимальную настройку и тестирование всех компонентов системы.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Применение установки оборудования
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Проекционные системы</h3>
                <p className="text-slate-600">Установка проекторов и экранов</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Установка звукового оборудования</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">LED панели</h3>
                <p className="text-slate-600">Установка светодиодных экранов</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для установки оборудования
            </p>
