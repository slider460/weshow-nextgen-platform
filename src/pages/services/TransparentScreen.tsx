...
import { ArrowLeft, View, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Полупрозрачные дисплеи для создания уникальных визуальных эффектов
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое прозрачный экран?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Прозрачные экраны — это инновационная технология, которая позволяет видеть 
                  контент на экране, сохраняя при этом видимость того, что находится за ним.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Идеально подходит для витрин, выставочных стендов и интерактивных инсталляций, 
                  где важно сохранить обзор пространства.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Розничные витрины</h3>
                <p className="text-slate-600">Интерактивные витрины с сохранением обзора товаров</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Выставочные стенды</h3>
                <p className="text-slate-600">Информационные панели для выставок</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Музеи и галереи</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для прозрачного экрана
            </p>
