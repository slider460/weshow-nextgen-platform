          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Настройка и оптимизация системных параметров
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Конфигурация систем — это процесс настройки системных параметров 
                  для достижения оптимальной производительности.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши специалисты настраивают все параметры системы, 
                  обеспечивая стабильную и эффективную работу.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Серверные системы</h3>
                <p className="text-slate-600">Настройка серверов и баз данных</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Сетевые системы</h3>
                <p className="text-slate-600">Настройка сетевого оборудования</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Безопасность</h3>
                <p className="text-slate-600">Настройка систем безопасности</p>
              </div>
            </div>
          </div>
        </div>
