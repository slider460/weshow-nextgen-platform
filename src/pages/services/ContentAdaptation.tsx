...
import { ArrowLeft, Palette, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Разработка визуальной концепции для различных платформ и устройств
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Адаптация контента — это процесс оптимизации визуальных материалов 
                  для различных платформ, устройств и форматов отображения.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения обеспечивают идеальное отображение контента 
                  на любых устройствах и в любых условиях.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Веб-сайты</h3>
                <p className="text-slate-600">Адаптивный дизайн для всех устройств</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600">Оптимизация для различных экранов</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Социальные сети</h3>
                <p className="text-slate-600">Адаптация для разных платформ</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для адаптации контента
            </p>
