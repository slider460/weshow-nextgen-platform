          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Профессиональная диагностика и выявление неисправностей
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Диагностика оборудования — это комплексный анализ технического состояния 
                  устройств для выявления неисправностей и предотвращения поломок.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши специалисты используют современное диагностическое оборудование 
                  для точного определения проблем и их устранения.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Применение диагностики оборудования
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Проекционное оборудование</h3>
                <p className="text-slate-600">Диагностика проекторов и экранов</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Аудиосистемы</h3>
                <p className="text-slate-600">Проверка звукового оборудования</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Световое оборудование</h3>
                <p className="text-slate-600">Диагностика LED панелей и прожекторов</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для диагностики оборудования
            </p>
