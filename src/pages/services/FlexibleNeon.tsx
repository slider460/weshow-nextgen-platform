...
import { ArrowLeft, Lightbulb, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Эластичная LED подсветка для создания уникальных световых эффектов
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Гибкий неон — это современная LED технология, которая позволяет создавать 
                  световые эффекты любой формы и размера, адаптируясь под ваши потребности.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения идеально подходят для декоративного освещения, 
                  рекламных вывесок и создания атмосферы на мероприятиях.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Рекламные вывески</h3>
                <p className="text-slate-600">Светящиеся логотипы и названия</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Декоративное освещение</h3>
                <p className="text-slate-600">Создание атмосферы на мероприятиях</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Архитектурная подсветка</h3>
                <p className="text-slate-600">Подсветка зданий и сооружений</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для гибкого неона
            </p>
