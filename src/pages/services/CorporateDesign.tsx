...
import { ArrowLeft, Package, Zap, Monitor, Users, Calendar, Phone } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Дизайн корпоративных подарков и сувениров для укрепления бренда
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6">
                  Что такое корпоративный дизайн?
                </h2>
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Корпоративный дизайн — это создание уникальных визуальных решений 
                  для корпоративных подарков, сувениров и промо-материалов.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Наши решения помогают компаниям укрепить бренд, 
                  создать запоминающиеся впечатления и укрепить отношения с клиентами.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Применение корпоративного дизайна
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Корпоративные подарки</h3>
                <p className="text-slate-600">Сувениры для клиентов и партнеров</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Промо-материалы</h3>
                <p className="text-slate-600">Рекламные материалы и брошюры</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Мероприятия</h3>
                <p className="text-slate-600">Дизайн для выставок и конференций</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Обсудим ваш проект и подберем оптимальное решение для корпоративного дизайна
            </p>
