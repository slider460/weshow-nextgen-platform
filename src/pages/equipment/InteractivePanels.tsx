...
const InteractivePanels = () => {
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Интерактивные панели — WESHOW"
        description="Сенсорные мультитач-панели для презентаций, игр и киосков. Аренда и интеграция. WESHOW."
        url="https://weshow.su/equipment/interactive-panels"
      />
      <Header />
