      ...
      <section className="pt-32 pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-extralight text-foreground mb-12 tracking-tight text-center">
              Условия использования
            </h1>
            
            <div className="prose prose-lg max-w-none">
              <div className="bg-card/50 backdrop-blur-sm rounded-3xl p-8 border border-border/50 space-y-8">
                <section>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">2. Использование сайта</h2>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">3. Ограничения</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Запрещается:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">4. Интеллектуальная собственность</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">5. Изменения условий</h2>
                  <p className="text-muted-foreground leading-relaxed">
