      ...
      <main className="pb-20">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
            <article className="lg:col-span-8 max-w-3xl text-slate-700">
              ...
              <p className="text-xl text-slate-600 leading-relaxed mb-8">
                Интерактивный просветительский стенд на ВДНХ: двусторонний экран‑парус с эффектом <ClickableKeyword keyword="Naked Eye" link="/services/transparent-screen" />, <ClickableKeyword keyword="Kinect‑игры" link="/services/interactive-games" />, <ClickableKeyword keyword="VR/AR" link="/services/ar-vr-apps" />, <ClickableKeyword keyword="кинетический экран" link="/services/kinetic-screen" />, <ClickableKeyword keyword="LED‑шары" link="/services/flexible-neon" /> и <ClickableKeyword keyword="мультимедийные панели" link="/services/info-panels" />.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <article className="clean-card">
                  ...
                  <ul className="list-disc pl-5 text-base leading-relaxed text-slate-700 space-y-1">
                    <li>Изогнутая часть — обложка стенда с контентом формата <ClickableKeyword keyword="Naked Eye" link="/services/transparent-screen" /> (стереоэффект без очков).</li>
                ...
                <article className="clean-card">
                  ...
                  <ul className="list-disc pl-5 text-base leading-relaxed text-slate-700 space-y-1">
                    ...
                    <li>ПО с информацией по департаментам и <ClickableKeyword keyword="интерактивные игры" link="/services/interactive-games" />: крестики‑нолики с «Союзом»/«Ладой», пазлы, профориентационные игры.</li>
                  </ul>
                </article>
                <article className="clean-card">
                  <h4 className="font-semibold mb-2">Две горизонтальных тач‑панели (86″) с <ClickableKeyword keyword="Kinect" link="/services/interactive-games" /></h4>
                  <ul className="list-disc pl-5 text-base leading-relaxed text-slate-700 space-y-1">
                ...
                <article className="clean-card">
                  <h4 className="font-semibold mb-2">Три <ClickableKeyword keyword="LED‑шара" link="/services/flexible-neon" /> (1,5 м)</h4>
                ...
                <article className="clean-card">
                  <h4 className="font-semibold mb-2"><ClickableKeyword keyword="Кинетический экран" link="/services/kinetic-screen" /> (5×3 м)</h4>
                ...
                <article className="clean-card">
                  <h4 className="font-semibold mb-2"><ClickableKeyword keyword="Прозрачный экран" link="/services/transparent-screen" /></h4>
                  <p className="text-base text-slate-700 leading-relaxed">Две вертикальные панели по 55″ каждая.</p>
                </article>
                <article className="clean-card">
                  <h4 className="font-semibold mb-2"><ClickableKeyword keyword="VR‑очки" link="/services/ar-vr-apps" /> и <ClickableKeyword keyword="AR‑очки" link="/services/ar-vr-apps" /></h4>
        ...
        <section id="content" className="py-12 border-t scroll-mt-28">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-slate-700">
            ...
            <ul className="list-disc pl-6 space-y-2 text-lg leading-relaxed text-slate-700">
              <li><ClickableKeyword keyword="3D‑контент" link="/services/three-d-modeling" />: природа, водная гладь, ладья, мост, автомобиль «Лада», памятник «Слава».</li>
              <li><ClickableKeyword keyword="3D‑герб" link="/services/three-d-modeling" /> Самарской области на парусе ладьи.</li>
              <li>Цифровые достижения региона.</li>
              <li>Проект «Самара в лицах»: <ClickableKeyword keyword="арт‑проект с нейросетями" link="/services/ai-chatbot" /> о выдающихся деятелях области.</li>
              ...
              <li><ClickableKeyword keyword="Интерактивное AR‑приложение" link="/services/ar-vr-apps" />: сборка ракеты «Союз» и запуск.</li>
              <li><ClickableKeyword keyword="VR‑кинотеатр" link="/services/ar-vr-apps" />: ключевые фильмы о Самарской области.</li>
            </ul>
          </div>
        </section>
