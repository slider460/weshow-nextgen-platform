-- Финальная настройка системы аутентификации WeShow NextGen Platform
-- Этот скрипт НЕ удаляет существующие функции, только создает новые таблицы
...
-- Удаление существующего триггера (если есть) и создание нового
